...
export default function CtaButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2.5 min-h-14 px-9 py-4 rounded-full font-semibold text-[20px] lg:text-[18px] leading-none tracking-[-0.01em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0CA6E8]";
