...
export default function ChiSiamoPage() {
  return (
    <>
      {/* HERO */}
      <section className="relative pt-16 lg:pt-20 pb-20 overflow-hidden scroll-mt-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-heading text-6xl lg:text-8xl text-[#E8EDF5] leading-none mb-6">
            CHI SIAMO
          </h1>
