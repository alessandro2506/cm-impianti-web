...
export default function CtaButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2.5 min-h-[3.25rem] px-10 py-4 md:min-h-[3.75rem] rounded-full font-semibold text-sm md:text-base leading-tight tracking-[-0.01em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0CA6E8]";
